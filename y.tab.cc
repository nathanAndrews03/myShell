...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GREATGREAT = 6,                 /* GREATGREAT  */
  YYSYMBOL_GREATAMPERSAND = 7,             /* GREATAMPERSAND  */
  YYSYMBOL_GREATGREATAMPERSAND = 8,        /* GREATGREATAMPERSAND  */
  ...
  YYSYMBOL_goal = 27,                      /* goal  */
  YYSYMBOL_arg_list = 28,                  /* arg_list  */
  YYSYMBOL_cmd_and_args = 29,              /* cmd_and_args  */
  YYSYMBOL_30_1 = 30,                      /* $@1  */
  YYSYMBOL_pipe_list = 31,                 /* pipe_list  */
  YYSYMBOL_io_modifier = 32,               /* io_modifier  */
  YYSYMBOL_io_modifier_list = 33,          /* io_modifier_list  */
  YYSYMBOL_background_optional = 34,       /* background_optional  */
  YYSYMBOL_SEPARATOR = 35,                 /* SEPARATOR  */
  YYSYMBOL_command_line = 36,              /* command_line  */
  YYSYMBOL_command_list = 37,              /* command_list  */
  YYSYMBOL_if_command = 38,                /* if_command  */
  YYSYMBOL_39_2 = 39,                      /* $@2  */
  YYSYMBOL_40_3 = 40,                      /* $@3  */
  YYSYMBOL_while_command = 41,             /* while_command  */
  YYSYMBOL_42_4 = 42,                      /* $@4  */
  YYSYMBOL_43_5 = 43,                      /* $@5  */
  YYSYMBOL_for_command = 44,               /* for_command  */
  YYSYMBOL_45_6 = 45,                      /* $@6  */
  YYSYMBOL_46_7 = 46                       /* $@7  */
};
...
{
       0,    52,    52,    55,    58,    62,    62,    71,    77,    86,
      91,    99,   106,   112,   116,   123,   124,   128,   132,   136,
     137,   143,   150,   161,   172,   182,   183,   184,   188,   193,
     201,   212,   200,   238,   249,   238,   274,   287,   273
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TWOGREAT", "AMPERSAND", "PIPE", "LESS", "NEWLINE", "IF", "FI", "THEN",
  "LBRACKET", "RBRACKET", "SEMI", "DO", "DONE", "WHILE", "FOR", "IN",
  "EXIT", "$accept", "goal", "arg_list", "cmd_and_args", "$@1",
  "pipe_list", "io_modifier", "io_modifier_list", "background_optional",
  "SEPARATOR", "command_line", "command_list", "if_command", "$@2", "$@3",
  "while_command", "$@4", "$@5", "for_command", "$@6", "$@7", YY_NULLPTR
};
...
{
      72,    18,   -63,   -63,    -5,   -63,    -4,    32,   -63,    21,
     -63,    25,   -63,   -63,     5,    18,    18,    18,   -63,   -63,
     -63,   -63,   -63,   -63,    36,    93,   -63,   -63,   -63,   -63,
      37,   -63,   -63,    22,   -63,    45,    46,    47,    48,    49,
     -63,    53,   -63,    18,   -63,     8,    11,   -63,   -63,   -63,
     -63,   -63,   -63,   -63,   -63,    41,    43,     4,    52,    50,
      54,   -63,   -63,   -63,    72,    72,    72,    19,    44,    58,
     -63,   -63,   -63
};
...
{
       0,     0,     5,    19,     0,    20,     0,     0,    25,     0,
       7,    16,    26,    28,     0,     0,     0,     0,    27,     4,
      30,    33,    36,     1,     0,    18,    29,    22,    23,    24,
       6,     4,     4,     0,     8,     0,     0,     0,     0,     0,
      17,     0,    15,     0,     3,     0,     0,     4,    10,     9,
      12,    11,    14,    13,    21,     0,     0,     0,     0,     0,
       0,    31,    34,    37,     0,     0,     0,     0,     0,     0,
      32,    35,    38
};
...
{
     -63,   -63,   -22,    40,   -63,   -63,   -63,   -63,   -63,     0,
     -14,   -62,   -63,   -63,   -63,   -63,   -63,   -63,   -63,   -63,
     -63
};
...
{
       0,     9,    30,    10,    19,    11,    42,    25,    43,    12,
      13,    14,    15,    31,    64,    16,    32,    65,    17,    33,
      66
};
...
{
      26,    18,    67,    68,    69,    -2,     1,    44,     2,    45,
      46,    44,    20,    21,    44,    27,    28,    29,     3,     4,
       1,    23,     2,    60,     5,    57,    55,     6,     7,    56,
       8,     3,     3,     4,    70,    22,    24,     5,     5,     2,
      44,     6,     7,    54,     8,     1,    47,     2,    48,    49,
      50,    51,    52,    26,    26,    26,    53,     3,     4,     1,
      58,     2,    59,     5,    34,    71,     6,     7,    61,     8,
      62,     3,     4,     1,    63,     2,     0,     5,     0,    72,
       6,     7,     0,     8,     0,     3,     4,     0,     0,     0,
       0,     5,     0,     0,     6,     7,     0,     8,    35,    36,
      37,    38,    39,    40,     0,    41
};

static const yytype_int8 yycheck[] =
{
      14,     1,    64,    65,    66,     0,     1,     3,     3,    31,
      32,     3,    17,    17,     3,    15,    16,    17,    13,    14,
       1,     0,     3,    19,    19,    47,    18,    22,    23,    18,
      25,    13,    13,    14,    15,     3,    11,    19,    19,     3,
       3,    22,    23,    43,    25,     1,    24,     3,     3,     3,
       3,     3,     3,    67,    68,    69,     3,    13,    14,     1,
      19,     3,    19,    19,    24,    21,    22,    23,    16,    25,
      20,    13,    14,     1,    20,     3,    -1,    19,    -1,    21,
      22,    23,    -1,    25,    -1,    13,    14,    -1,    -1,    -1,
      -1,    19,    -1,    -1,    22,    23,    -1,    25,     5,     6,
       7,     8,     9,    10,    -1,    12
};
...
{
       0,     1,     3,    13,    14,    19,    22,    23,    25,    27,
      29,    31,    35,    36,    37,    38,    41,    44,    35,    30,
      17,    17,     3,     0,    11,    33,    36,    35,    35,    35,
      28,    39,    42,    45,    29,     5,     6,     7,     8,     9,
      10,    12,    32,    34,     3,    28,    28,    24,     3,     3,
       3,     3,     3,     3,    35,    18,    18,    28,    19,    19,
      19,    16,    20,    20,    40,    43,    46,    37,    37,    37,
      15,    21,    21
};
...
#line 100 "shell.y"
		...
		Shell::TheShell->_pipeCommand->_errFile = new std::string((yyvsp[0].cpp_string)->c_str());
		Shell::TheShell->_pipeCommand->_append = true;
	 }
#line 1232 "y.tab.cc"
    break;
...
#line 1421 "y.tab.cc"
  ...
  case 35: /* while_command: WHILE LBRACKET $@4 arg_list RBRACKET SEMI DO $@5 command_list DONE  */
#line 255 "shell.y"
        {
		Shell::TheShell->_level--;
...
#line 274 "shell.y"
		...
		Shell::TheShell->_ifCommand = new IfCommand();
		Shell::TheShell->_ifCommand->forArg = *(yyvsp[0].cpp_string);
	}
#line 1458 "y.tab.cc"
    break;
...
#line 1470 "y.tab.cc"
  ...
  case 38: /* for_command: FOR WORD $@6 IN arg_list SEMI DO $@7 command_list DONE  */
#line 295 "shell.y"
        {
		Shell::TheShell->_level--;
		if (Shell::TheShell->_level == 0 && !Shell::TheShell->listCommandsStack.empty()) {
